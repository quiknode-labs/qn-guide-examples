  ...
  return (
    <div className="flex flex-col w-full min-h-screen p-4 md:p-10 space-y-4">
      ...
      <Card>
        ...
        <CardContent>
          Learn more about the Solana Metaplex Digital Asset Standard (DAS) API <Link href="https://www.quicknode.com/metaplex-das-api?utm_source=internal&utm_campaign=dapp-examples&utm_content=Solana-Explorer" target="_blank">here</Link>.
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="text-lg font-bold">
